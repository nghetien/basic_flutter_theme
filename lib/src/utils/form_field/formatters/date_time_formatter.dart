...
class BasicDateTimeFormatter {
  BasicDateTimeFormatter._privateConstructor();

  static final BasicDateTimeFormatter _instance = BasicDateTimeFormatter._privateConstructor();

  factory BasicDateTimeFormatter() => _instance;
