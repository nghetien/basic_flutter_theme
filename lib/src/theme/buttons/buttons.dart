...
class BasicButton {
  ...
  static Widget outline({
    ...
    Color textColor = BasicAppColors.black,
    Color borderColor = BasicAppColors.darkGrey,
    double radius = BasicCorners.corner5,
    Color background = BasicAppColors.white,
    ...
    TextStyle? textStyle,
    double borderWidth = BasicBorders.thin,
          ...
          child: Padding(
            padding: padding ??
                EdgeInsets.symmetric(
                  horizontal: BasicPaddings.lg,
                  vertical: BasicPaddings.med,
                ),
            child: Row(
              ...
              children: [
                ...
                Flexible(
                  child: Text(
                    ...
                    maxLines: maxLines,
                    style: textStyle ??
                        BasicTextStyles.buttonMedium.copyWith(
                          color: textColor,
                          height: 0,
                        ),
                  ),
